...
broker — nine runs put ``confluent-kafka`` at 166 to 295 microseconds against ``aiokafka``'s
354 to 492, so 1.3 to 2.2 times. The claim that has held is the plain one — ``confluent-kafka``
